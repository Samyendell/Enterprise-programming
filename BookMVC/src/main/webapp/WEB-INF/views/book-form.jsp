            ...
            <form method="post"
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="invalid-feedback">Title is required (5–150 characters).</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="invalid-feedback">Author is required (5–150 characters).</div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="invalid-feedback">Genres is required (3–50 characters).</div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback">Characters is required (5–200 characters).</div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback">Synopsis is required (5–1000 characters).</div>
                    </div>
                </div>
