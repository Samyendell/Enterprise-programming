...
const PAGE_SIZE = 10;
/**
 * This file is the root component for the frontend application which consumes the other react components, 
 * this files responsibilites include managing pagination and sorting, controlling the flow of adding, 
 * editing and deleting books from a UI perspective. The validation present follows the patterns used
 * on the server. This file works with book service to handle CRUD operations.
 */
